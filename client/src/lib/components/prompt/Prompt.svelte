...
<div
    class="w-[90%] m-auto rounded-xl bg-[#333333]/90 backdrop-blur-lg shadow-xl border border-gray-40"
>
    ...
    <div class="w-full border relative h-12 rounded-b-xl">
        <div
            class="absolute top-0 bg-[#3E8E97] rounded-tl-2xl rounded-bl-2xl text-white rounded-br-xl py-3 px-5 text-md active:scale-95 transition-all right-0"
        >
